...
public class DistribuidoraTest {
	...
	@BeforeEach
	public void setUp() {
		this.distribuidora = new Distribuidora(50.0);
		this.redCompleta = new Distribuidora(10.0);
	...
	public void testConsumoTotalDeLaRed() {
		...
		assertEquals(5400, this.redCompleta.consumoTotalActiva(), 0.001);
		Consumo otro = new Consumo(LocalDate.of(2021, 7, 15), 100, 800);
		this.frida.agregarMedicion(otro);
		assertEquals(500, this.redCompleta.consumoTotalActiva(), 0.001);
	}
	...
	public void testSetPrecioKW() {
		this.distribuidora.precioKWh(200.0);
